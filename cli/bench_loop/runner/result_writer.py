    ...
    *,
    ...
    run_dict = {
        ...
        "stack": {
            ...
            "engine_version": "",
            "provider": provider,
            "runtime_config": {"harness": harness, "suites": suites},
            "context_length": 0,
            "hardware_class": "",
            "os": machine.get("os", ""),
        },
        ...
        "value_score": 0,
        "speed_metrics": {},
        "memory_metrics": {"oom_rate": 1.0 if "oom" in error.lower() or "out of memory" in error.lower() else 0.0},
        "stability_metrics": {"success_rate": 0.0, "run_count": 0},
        "quality_retention_metrics": {},
        "can_it_run": "OOM" if "oom" in error.lower() or "out of memory" in error.lower() else "Fails to load",
        "is_stack_benchmark": False,
        "legacy_model_run": True,
        "total_runtime_sec": 0,
        "error": error,
