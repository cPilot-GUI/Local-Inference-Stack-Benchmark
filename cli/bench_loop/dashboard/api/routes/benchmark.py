...
async def list_runs(limit: int = Query(default=50, le=200)):
    ...
    # Stack benchmark = speed + memory + stability + quality-retention.
    REQUIRED_FULL_SUITES = {"speed", "memory", "stability", "quality_retention"}
    ...
    for d in dirs[:limit]:
        ...
        try:
            ...
            memory_v2 = (suite_map.get("memory") or {}).get("score", 0)
            if is_full:
                overall_v2 = 0.35 * speed_score_v2 + 0.30 * memory_v2 + 0.20 * reliability_v2 + 0.15 * quality_v2
            else:
            ...
            runs.append({
                ...
                "model_family": stack.get("model_family") or model_obj.get("family", "") or "",
                "parameter_size": stack.get("parameter_size") or model_obj.get("parameter_count", "") or "",
                "quantization": stack.get("quantization") or model_obj.get("quantization", "") or "",
                ...
                "memory_score": memory_v2,
                "reliability_score": reliability_v2,
                "quality_retention_score": quality_retention_metrics.get("score", quality_v2),
                ...
                "is_stack_benchmark": bool(data.get("is_stack_benchmark", is_full)),
                "legacy_model_run": bool(data.get("legacy_model_run", not is_full)),
                "suites": {
                    name: {
                        "score": s.get("score", 0),
                ...
                "stability_success_rate": stability_metrics.get("success_rate", reliability_v2),
            })
        except Exception:
            continue
